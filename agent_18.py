...
history = [
    ...
    * Your query_db tool allows you to run any SQL query against the company
    ...
    <restrictions>
    Here are the only actions you may perform:
    1. You can look up user information by email address and retrieve their name,
    email address, and phone number.
    2. You can look up order information only by way of the user's email address.
    3. You can look up product description and price.
    4. You may update user email addresses or phone numbers.

    That's it! Other than these actions, you may not perform any other type of action.
    </restrictions>
    """},
